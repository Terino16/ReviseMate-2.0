    ...
    <>
      <section className="feature-section py-12 sm:py-20">
        <div className="max-w-[1100px] mx-auto px-4 sm:px-6">
          <h2 className="feature-heading font-serif text-[2rem] sm:text-[2.8rem] md:text-[3.5rem] font-normal text-center leading-tight mb-8 sm:mb-14">
            Built to help you learn better,
            <br />
            every step of the way.
          </h2>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 justify-items-center items-start">
      ...
      <section className="relative h-[320px] sm:h-[480px] md:h-[640px] overflow-hidden">
        <Image
      ...
      <section className="py-12 sm:py-24">
        <div className="max-w-[1100px] mx-auto flex flex-col gap-12 sm:gap-20 px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div>
              <h2 className="font-serif text-[1.6rem] sm:text-[2.2rem] font-normal leading-snug text-dark mb-4 sm:mb-5">
                Learn with clarity, not confusion
              </h2>
              <p className="text-[0.95rem] sm:text-[1rem] leading-relaxed text-gray-rm max-w-[400px]">
            ...
            <div className="flex items-center justify-center bg-cream rounded-2xl p-6 sm:p-10">
              <Image src="/Card1.png" alt="Guided practice illustration" width={400} height={400} className="object-contain" />
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="flex items-center justify-center bg-cream rounded-2xl p-6 sm:p-10 order-2 md:order-1">
