...
export default function Hero() {
    return (
        ...
        >
            ...
            <div className="relative max-w-[1100px] mx-auto px-4 sm:px-6 py-10 sm:py-20">
                <Navbar />
                <div className="flex flex-col items-center justify-center space-y-6 sm:space-y-8 mt-[100px] sm:mt-[80px]">
                    ...
                    <div className="hero-in-3 mt-4 sm:mt-6 w-full px-2">
                        <Image src="/Dashboard.png" alt="Hero Image" width={1000} height={1400} className="h-full w-full" />
                    </div>
                </div>
            </div>
        </div>
